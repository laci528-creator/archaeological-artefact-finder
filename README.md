...
- Database-backed favorite storage
- Themed UI design
- Loading animation
- API error handling
...
- Further improve the responsive design

## Project Purpose

This project was created as a portfolio project to combine archaeological interest with modern web development.

It demonstrates API integration, React components, backend routing, pagination, database integration, error handling and responsive UI design.
